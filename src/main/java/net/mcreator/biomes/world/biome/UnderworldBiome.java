...
public class UnderworldBiome extends BiomesModElements.ModElement {
	public static Biome biome;
	public UnderworldBiome(BiomesModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("biomes:underworld"));
			}
		}
	}
	@Override
