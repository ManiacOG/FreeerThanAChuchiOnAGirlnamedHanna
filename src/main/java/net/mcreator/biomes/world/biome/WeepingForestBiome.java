...
public class WeepingForestBiome extends BiomesModElements.ModElement {
	public static Biome biome;
	public WeepingForestBiome(BiomesModElements instance) {
		super(instance, 1);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-6710785).withGrassColor(9470285).build();
				...
				event.getRegistry().register(biome.setRegistryName("biomes:weeping_forest"));
			}
		}
	}
	@Override
