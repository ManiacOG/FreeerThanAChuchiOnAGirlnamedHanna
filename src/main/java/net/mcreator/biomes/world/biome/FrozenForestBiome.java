...
public class FrozenForestBiome extends BiomesModElements.ModElement {
	public static Biome biome;
	public FrozenForestBiome(BiomesModElements instance) {
		super(instance, 4);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-7877240).withGrassColor(-8208809).build();
				...
				event.getRegistry().register(biome.setRegistryName("biomes:frozen_forest"));
			}
		}
	}
	@Override
